...
const Login = () => {
  return (
    <>
      <div className="absolute -top-[1px] pb-[1px] z-[2] px-[1px] left-1/2 transform -translate-x-1/2 bg-gradient-to-bl from-[#2B54E7] to-[rgba(255,255,255,0)]   rounded-b-xl text-lg sm:text-2xl font-bolder">
