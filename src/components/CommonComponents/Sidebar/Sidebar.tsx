...
const Sidebar = () => {
  ...
  return (
    <div className='w-[240px] fixed bg-gradient-to-r from-[rgba(47,54,97,0.28)] to-[rgba(37,42,76,0.1)] h-screen border-r-gradient flex flex-col items-start justify-start px-4 py-8'>
